...
.dtp div.dtp-date, .dtp div.dtp-time { background: #00C292; text-align: center; color: #fff; padding: 10px; }
...
.dtp table.dtp-picker-days tr > td > a.selected{ background: #00C292; color: #fff; }
...
.dtp .dtp-actual-meridien a.selected { background: #00C292; color: #fff; }
