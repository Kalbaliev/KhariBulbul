...
//Selecte məlumat ötürmək üçün
var dil= document.getElementById("ForLanguage").title;
var noneTextForSelect="test"

if(dil=='az'){
   noneTextForSelect="Uyğun otaq tapılmadı";
}
else if (dil=='en'){
   noneTextForSelect="Not found available";
}
//Mənim qurdöum hissie yuxarıdakı
...
! function(a, b) {
    ...
    ! function(a) {
        ...
        l.VERSION = "1.12.4", l.DEFAULTS = {
            noneSelectedText: noneTextForSelect,
